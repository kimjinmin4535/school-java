 ...
 * 		1) print() : ()괄호안의 내용 그대로 출력하고, 오른쪽 칸부터 출력을 시작함.
 * 		2) println() : print a line, ()괄호안의 내용 그대로 출력하고, 
 * 					   그 다음에 출력할 내용이 있으면 다음줄 첫번째 칸부터 출력 시작함.
 * 		3) printf() : print in format, ()괄호안의 내용을 "형식"에 맞추어 출력하고,
 * 					  그 다음에 출력할 내용이 있으면 출력된 내용의 오른쪽 칸부터 출력을 시작함.
 * 
 * 2. escape character
...
public class Printf {
	...
	public static void main(String[] args) {
		...
		System.out.printf("[%X]\n", number);
		// 16진법 정수를 5자리로 오른쪽 정렬하고 알파벳은 대문자로 출력하시오.
		System.out.printf("[%5X]\n", number);
		// 16진법 정수를 5자리로 왼쪽 정렬하고 알파벳은 소문자로 출력하시오.
		System.out.printf("[%-5x]\n", number);
		...
		// 실수를 15자리 오른쪽 정렬하고, 소수점은 1번째자리까지 출력하시오.
		System.out.printf("[%15.1f]\n", d);
		// 실수를 15자리 왼쪽 정렬하고, 소수점은 3번째자리까지 출력하시오.
		System.out.printf("[%-15.3f]\n", d);
		// 실수를 15자리 오른쪽 정렬하고, 왼쪽 빈자리는 0으로, 소수점은 3번째자리까지 출력하시오.
		...
		//4) %문자의 갯수가 넘어오는 값의 갯수보다 많으면 문제가 발생함.
